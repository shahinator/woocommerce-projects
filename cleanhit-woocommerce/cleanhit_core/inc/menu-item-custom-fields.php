...
if ( ! class_exists( 'cleanhit_Menu_Item_Custom_Fields' ) ) :
	/**
	* Menu Item Custom Fields Loader
	*/
	class cleanhit_Menu_Item_Custom_Fields {
		...
		*/
		public static function _filter_walker( $walker ) {
			$walker = 'cleanhit_Menu_Item_Custom_Fields_Walker';
	...
	add_action( 'wp_loaded', array( 'cleanhit_Menu_Item_Custom_Fields', 'load' ), 9 );
endif;  

require_once dirname( __FILE__ ) . '/menu-item-custom-fields-options.php';
