...
<div class="prd-sm">
                            ...
                            <h3>
									<?php
										...
										if ( $_product->backorders_require_notification() && $_product->is_on_backorder( $cart_item['quantity'] ) ) {
											echo '<p class="backorder_notification">' . esc_html__( 'Available on backorder', 'cleanhit' ) . '</p>';
										}
									?>
							</h3>
                            <div class="price">
	...
	<?php else : ?>
		<span class="empty"><?php _e( 'No products in the cart .', 'cleanhit' ); ?></span>
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	<div class="header-cart-total">
		<div class="pull-left"><?php _e( 'Total', 'cleanhit' ); ?>:</div>
