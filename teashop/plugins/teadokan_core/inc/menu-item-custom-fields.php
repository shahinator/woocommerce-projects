...
if ( ! class_exists( 'teadokan_Menu_Item_Custom_Fields' ) ) :
	/**
	* Menu Item Custom Fields Loader
	*/
	class teadokan_Menu_Item_Custom_Fields {
		...
		*/
		public static function _filter_walker( $walker ) {
			$walker = 'teadokan_Menu_Item_Custom_Fields_Walker';
	...
	add_action( 'wp_loaded', array( 'teadokan_Menu_Item_Custom_Fields', 'load' ), 9 );
endif;  
