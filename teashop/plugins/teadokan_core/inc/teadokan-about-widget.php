...
add_action('widgets_init', 'teadokan_about_load_widgets');
function teadokan_about_load_widgets(){
	register_widget('teadokan_about_Widget');
}


class teadokan_about_Widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'deadokan_about', 'description' => esc_html__('Teadokan: About Widget','deadokan'));
		$control_ops = array('id_base' => 'deadokan_about-widget');
		parent::__construct('deadokan_about-widget', esc_html__('Teadokan: About Widget','deadokan'), $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => 'About Teadokan','description' => '','fb' => '','tw' => '', 'pin' => '','ld' => '','inst' => '' );
