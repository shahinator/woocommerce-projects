						...
						if ( have_posts() ) :
							...
							endwhile;?>
								...
								<?php the_posts_pagination( array(
										'mid_size' => 2,
										'prev_text' => __( '<i class="fa fa-long-arrow-left" aria-hidden="true"></i>', 'teadokan' ),
										'next_text' => __( '<i class="fa fa-long-arrow-right" aria-hidden="true"></i>', 'teadokan' ),
									) ); 
									?>
								</div>
